    ...
    <div className="main-page">
      <div className="main-credit-flex">
        <div className="credit-card">
          <Link className="cc-name" to="/app">Back to Bets</Link>
        </div>  
        <div className="credit-card">
          <h2 className="cc-name">Ryan Woods</h2>
          <div className="credit-card-links">
            <li className="cc-link"><a target="_blank" href="https://www.linkedin.com/in/zachary-currell-williams/">Portfolio</a></li>
